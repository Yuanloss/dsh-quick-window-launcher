...
/**
 * Create (or refresh) the desktop shortcut that launches the harness.
 * @param {object} r - runtime facts.
...
// loader at runtime.
export { deriveRuntime, watchdogScript, watchdogLauncherScript, launchWebScript, ensureShortcutScript, psQuote, psArray, psArgList }
